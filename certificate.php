    ...
    <div id="content"> <!------Logo Background-->
        <div class="opct" > <!--------------Gradient Overlay-->
            <div class="container" id="main">
                ...
                <p class="text"><?php $currency = array_search($country_name, $curr);if ($currency) {echo $currency;}else{echo $country_code; }?> <?php echo number_format($_SESSION['net_worth'],2); ?></p> <br>
